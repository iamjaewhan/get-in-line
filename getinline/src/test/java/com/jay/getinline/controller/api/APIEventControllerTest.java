...
import com.jay.getinline.controller.EventController;
...
class APIEventControllerTest {
    ...
    @DisplayName("[API][PUT] 이벤트 정보 변경")
    @Test
    void givenEventInfo_whenModifyingEvent_thenReturnsSucessStandardResponse() throws Exception{
        //Given
        long eventId = 1L;
        EventResponse eventResponse = EventResponse.of(
                1L,
